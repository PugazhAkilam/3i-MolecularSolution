...
const ConsultationTab = () => {
  const [preExistingProblems, setPreExistingProblems] = useState(['Biabties', 'Knee Pain']);
  ...
  const handleAddMedicine = () => {
    if (newMedicine.name.trim() === '') return; // optional validation
  ...
  return (
    <Box sx={{ padding: '0 30px' }}>
      ...
      <TextField
        ...
        multiline
        rows={1}
        defaultValue="Sore throat, fever x 1 day"
        sx={{ mb: 3 }}
      />
